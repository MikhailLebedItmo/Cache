...
| --mem_size <размер>                  | Задает размер оперативной памяти (в байтах).                                                    |
| --cache_size <размер>                | Задает размер кэша (в байтах).                                                                  |
| --cache_line_size <размер>           | Задает размер кэш-линии (в байтах).                                                             |
| --cache_ways <количество>            | Задает количество ассоциативных путей
